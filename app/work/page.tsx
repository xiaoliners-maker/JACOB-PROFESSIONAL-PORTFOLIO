...
import { getAllProjects, getAllCategories, getAllTechStacks } from "@/lib/content";
    ...
    <div className="py-16">
      <Container>
        <section className="mb-16">
          <h1 className="text-3xl sm:text-4xl font-semibold text-ink tracking-tight mb-4">All Work</h1>
          <p className="text-base text-ink-muted leading-relaxed max-w-2xl">
            Every project built across 11 weeks of internship — from landing pages and research tools
