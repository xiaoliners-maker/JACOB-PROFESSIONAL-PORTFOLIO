...
export default function Button({
  ...
  const base =
    "inline-flex items-center justify-center font-medium transition-all duration-200 rounded-xl min-h-[44px] min-w-[44px] cursor-pointer select-none active:scale-[0.97]";
